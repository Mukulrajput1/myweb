...
function Warn() {
  ...
  return (
    <div>
      <div
        className={`fixed bottom-20 left-[42%] bg-black bg-opacity-60 pt-5 text-white w-auto h-[70px] flex-col justify-center items-center ${
          msg
      ...
      >
        ...
        <div className="h-1 w-full bg-gray-300 absolute bottom-0">
      <div className={`absolute top-0 left-0 h-full ${click?"bg-red-500":"bg-black bg-opacity-60"} ${msg?"w-[100%] transition-all duration-[2500ms]":"w-[0%] transition-all"}`} ></div>
    </div>
      </div>
    </div>
  );
